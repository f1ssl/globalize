...
To make a long story short, the algorithm in globalize 1.3.0 has been significantly improved and it allows using virtually any skeletons except for some special cases.
